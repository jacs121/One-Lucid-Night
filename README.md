...
* ADVANCING RUNE  (1 use): `appears at the end of a wave, used to start the next wave`
* PELLET RUNE (1 use): `adds more pellets per shot`
* SHARPEN RUNE (2 uses): `makes the pellets deal more damage`
